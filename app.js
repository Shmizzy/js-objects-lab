...
game.party.push(pokemon[12], pokemon[53], pokemon[44]);
...
*/
  ...
  game.party.splice(1,1, pokemon[7]);
...
*/
    ...
    for(let i = 0; i < pokemon.length; i++){
        if(pokemon[i].starter === true){
            console.log(`Starters: ${pokemon[i].name}`);
        }
  }
...
*/
    ...
    game.partyCount = "Pokemon count: " + game.party.length; 
